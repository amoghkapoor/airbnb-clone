...
const InfoCard = ({image, location, description, star, price, total, title}) => {
    return (
        <div className="flex py-7 px-8 border-b cursor-pointer hover:opacity-80 hover:shadow-lg transition ease-out duration-200 first:border-t">
            ...
            <div className="flex flex-col pl-5 flex-grow">
                ...
                <div className="flex justify-between item-end pt-5">
                    <p className="flex items-center"><StarIcon className="h-5 text-yellow-500"/>{star}</p>
                    <div>
